...
The main integration, push, local Signal/Host restart and unchanged tunnel checks will be recorded only after execution. Physical Android/iPhone/iPad, system IME/WebKit, Quartz, live/public Viewer input, watcher fault and real PTY acceptance remain NOT RUN.
